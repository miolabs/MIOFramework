...
export interface XMLParserDelegate {
    ...
    parserDidStartElement?(parser:XMLParser, element:string, attributes) : void;
    parserDidEndElement?(parser:XMLParser, element:string) : void;

    parserFoundCharacters?(parser:XMLParser, characters:string) : void;
    parserFoundComment?(parser:XMLParser, comment:string) : void;
}
...
{
    private str:string;
    private delegate:XMLParserDelegate|null = null;

    private strIndex = 0;

    private elements:any[] = [];
    private attributes:any|null = null;
    private currentElement:any|null = null;
    private currentTokenValue:XMLTokenType|null = null;
    private lastTokenValue:XMLTokenType|null = null;
    ...
    private nextToken() : [ XMLTokenType, string|null ]{
    ...
    private prevToken() : XMLTokenType|null {        
    ...
    private beginElement(value:any){
