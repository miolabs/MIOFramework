...
{
    dateStyle = DateFormatterStyle.ShortStyle;
    timeStyle = DateFormatterStyle.ShortStyle;    
    ...
    stringForObjectValue(value):string {
        ...
        switch (this.dateStyle) {
            ...
            case DateFormatterStyle.ShortStyle:
                str = this._shortDateStyle(date);
                break;

            case DateFormatterStyle.FullStyle:
                str = this._fullDateStyle(date);
                break;
        }        

        if (this.dateStyle != DateFormatterStyle.NoStyle && this.timeStyle != DateFormatterStyle.NoStyle)
            str += " ";
