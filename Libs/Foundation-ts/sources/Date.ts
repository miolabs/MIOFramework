...
import { MIOCoreLexer } from "mio-core";
...
let _NSDateFirstWeekDay = NSDateFirstWeekDay.Monday;
let _NSDateStringDays = ["Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday", "Sunday"];
let _NSDateStringMonths = ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"];
