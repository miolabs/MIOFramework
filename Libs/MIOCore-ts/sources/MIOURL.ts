...
export function MIOHTTPRequest(instance:any, urlString:string, headers:any, method:string, body:any, binary:boolean, delegate:any, target:any, completion:any, download: boolean, fileName?:string) {
...
function MIOCoreLoadFileFromURL(url:string, callback:any){
