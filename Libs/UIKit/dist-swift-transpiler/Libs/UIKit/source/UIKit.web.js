...
var mio_foundation_web_20 = require("mio-foundation-web");
var mio_foundation_web_21 = require("mio-foundation-web");
var mio_foundation_web_22 = require("mio-foundation-web");
var mio_foundation_web_23 = require("mio-foundation-web");
var mio_foundation_web_24 = require("mio-foundation-web");
var mio_foundation_web_25 = require("mio-foundation-web");
...
exports.MUICoreBundleSetClassesByDestination = MUICoreBundleSetClassesByDestination;
function MUICoreBundleGetClassesByDestination(resource) {
    return _MIOCoreBundleClassesByDestination[resource];
}
exports.MUICoreBundleGetClassesByDestination = MUICoreBundleGetClassesByDestination;
function MUICoreBundleLoadNibName(name, target, completion) {
    var parser = new MUICoreNibParser();
    parser.target = target;
    parser.completion = completion;
    mio_foundation_web_5.MIOCoreBundleGetContentsFromURLString(name, this, function (code, data) {
        if (code == 200)
...
var MUICoreNibParser = /** @class */ (function (_super) {
    ...
    MUICoreNibParser.prototype.parseString = function (data) {
        var parser = new mio_foundation_web_3.MIOCoreHTMLParser();
    ...
    MUICoreNibParser.prototype.translateCharacters = function () {
        if (this.currentString != null) {
            if (this.currentStringLocalizedKey == null) {
                ...
                this.result += mio_foundation_web_4.NSLocalizeString(this.currentStringLocalizedKey, this.currentString);
            }
        }
        this.currentString = null;
...
var UIPanGestureRecognizer = /** @class */ (function (_super) {
    ...
    UIPanGestureRecognizer.prototype.translationInView = function (view) {
        return new mio_foundation_web_7.NSPoint(this.deltaX, this.deltaY);
    };
...
var UIView = /** @class */ (function (_super) {
        ...
        if (this.layer.childNodes.length > 0) {
            for (var index = 0; index < this.layer.childNodes.length; index++) {
                ...
                if (className == null || className.length == 0)
                    className = "UIView";
                var sv = mio_foundation_web_6.NSClassFromString(className);
    ...
    UIView.prototype.copy = function () {
        ...
        var view = mio_foundation_web_6.NSClassFromString(className);
    ...
    Object.defineProperty(UIView.prototype, "frame", {
        get: function () {
            return mio_foundation_web_8.NSRect.rectWithValues(this.getX(), this.getY(), this.getWidth(), this.getHeight());
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(UIView.prototype, "bounds", {
        get: function () {
            return mio_foundation_web_8.NSRect.rectWithValues(0, 0, this.getWidth(), this.getHeight());
        },
        enumerable: true,
        configurable: true
    });
...
})(UIControlEvents = exports.UIControlEvents || (exports.UIControlEvents = {}));
...
var UIButton = /** @class */ (function (_super) {
    ...
    UIButton.prototype.setupLayers = function () {
        ...
        if (key != null)
            this.setTitle(mio_foundation_web_4.NSLocalizeString(key, key));
        // Prevent click
...
var UITextField = /** @class */ (function (_super) {
    ...
    UITextField.prototype._setupLayer = function () {
        ...
        if (placeholderKey != null)
            this._inputLayer.setAttribute("placeholder", mio_foundation_web_4.NSLocalizeString(placeholderKey, placeholderKey));
...
var UIViewController = /** @class */ (function (_super) {
    ...
    function UIViewController(layerID) {
        ...
        _this.modalPresentationStyle = mio_foundation_web_10.MIOCoreIsPhone() == true ? UIModalPresentationStyle.FullScreen : UIModalPresentationStyle.PageSheet;
        _this.modalTransitionStyle = UIModalTransitionStyle.CoverVertical;
        _this.transitioningDelegate = null;
        _this._contentSize = new mio_foundation_web_9.NSSize(320, 200);
    ...
    UIViewController.prototype.localizeSubLayers = function (layers) {
        ...
        for (var index = 0; index < layers.length; index++) {
            ...
            if (key != null)
                layer.innerHTML = mio_foundation_web_4.NSLocalizeString(key, key);
    ...
    UIViewController.prototype._didLoadView = function () {
        ...
        if (mio_foundation_web_10.MIOCoreIsPhone() == true)
...
var UIPresentationController = /** @class */ (function (_super) {
    ...
    UIPresentationController.prototype.presentationTransitionWillBegin = function () {
        ...
        if (toVC.modalPresentationStyle == UIModalPresentationStyle.PageSheet
            ...
            || mio_foundation_web_10.MIOCoreIsPhone() == true) {
    ...
    UIPresentationController.prototype._calculateFrame = function () {
        ...
        if (toVC.modalPresentationStyle == UIModalPresentationStyle.FullScreen) {
            ...
            view.setFrame(mio_foundation_web_8.NSRect.rectWithValues(0, 0, w, h));
        }
            ...
            if (size == null)
                size = new mio_foundation_web_9.NSSize(320, 200);
            var w = size.width;
            var h = size.height;
            var x = (ws.width - w) / 2;
            view.setFrame(mio_foundation_web_8.NSRect.rectWithValues(0, 0, w, h));
            this.window.setFrame(mio_foundation_web_8.NSRect.rectWithValues(x, 0, w, h));
            ...
            var y = (ws.height - h) / 2;
            view.setFrame(mio_foundation_web_8.NSRect.rectWithValues(0, 0, w, h));
            this.window.setFrame(mio_foundation_web_8.NSRect.rectWithValues(x, y, w, h));
            view.layer.classList.add("modal");
        }
        else {
            var size = toVC.preferredContentSize;
    ...
    Object.defineProperty(UIPresentationController.prototype, "window", {
        ...
        set: function (window) {
            ...
            if (mio_foundation_web_11.MIOCoreIsMobile() == false && vc.modalPresentationStyle != UIModalPresentationStyle.CurrentContext) {
...
var UIPopoverPresentationController = /** @class */ (function (_super) {
    ...
    function UIPopoverPresentationController() {
        ...
        _this.sourceRect = mio_foundation_web_8.NSRect.Zero();
        _this.delegate = null;
...
var UIScrollView = /** @class */ (function (_super) {
    ...
    UIScrollView.prototype.setupLayer = function () {
        if (mio_foundation_web_13.MIOCoreGetPlatform() == mio_foundation_web_14.MIOCorePlatformType.Safari)
    ...
    UIScrollView.prototype.scrollEventCallback = function () {
        ...
        this.scrollTimer = mio_foundation_web_12.NSTimer.scheduledTimerWithTimeInterval(150, false, this, this.scrollEventStopCallback);
    ...
    Object.defineProperty(UIScrollView.prototype, "contentOffset", {
        get: function () {
            var p = new mio_foundation_web_7.NSPoint(this.layer.scrollLeft, this.layer.scrollTop);
            return p;
        },
        set: function (point) {
            if (point.x > 0)
    ...
    Object.defineProperty(UIScrollView.prototype, "bounds", {
        get: function () {
            ...
            return mio_foundation_web_8.NSRect.rectWithValues(p.x, p.y, this.getWidth(), this.getHeight());
        },
        enumerable: true,
        configurable: true
    });
...
var UITableView = /** @class */ (function (_super) {
    ...
    UITableView.prototype.dequeueReusableCellWithIdentifier = function (identifier) {
        ...
        cell = mio_foundation_web_6.NSClassFromString(className);
    ...
    UITableView.prototype.addSectionHeader = function (section) {
        var header = this.dataSource.viewForHeaderInSection(this, section);
        if (header == null)
            return;
        header.hidden = false;
    ...
    UITableView.prototype.nextIndexPath = function (indexPath) {
        ...
        if (rowIndex < section.length)
            return mio_foundation_web_15.NSIndexPath.indexForRowInSection(rowIndex, sectionIndex);
        sectionIndex++;
        if (sectionIndex >= this.sections.length)
            return null;
        ...
        if (section.length == 0)
            return null;
        return mio_foundation_web_15.NSIndexPath.indexForRowInSection(0, sectionIndex);
    };
    ...
    UITableView.prototype.reloadData = function () {
        ...
        for (var sectionIndex = 0; sectionIndex < sections; sectionIndex++) {
            ...
            for (var cellIndex = 0; cellIndex < rows; cellIndex++) {
                var ip = mio_foundation_web_15.NSIndexPath.indexForRowInSection(cellIndex, sectionIndex);
                this.addCell(ip);
            }
    ...
    UITableView.prototype.cellDidTap = function (gesture) {
        ...
        if (this.delegate != null && typeof this.delegate.didSelectCellAtIndexPath === "function") {
            this.delegate.didSelectCellAtIndexPath(this, mio_foundation_web_15.NSIndexPath.indexForRowInSection(rowIndex, sectionIndex));
        }
    };
...
var UISplitViewController = /** @class */ (function (_super) {
    ...
    UISplitViewController.prototype.init = function () {
        ...
        if (mio_foundation_web_10.MIOCoreIsPhone() == false)
...
function MUIOutlet(owner, elementID, className, options) {
    ...
    if (className == null)
        className = "UIView";
    var classInstance = mio_foundation_web_6.NSClassFromString(className);
...
function MUIWindowSize() {
    ...
    return new mio_foundation_web_9.NSSize(w, h);
}
...
var UIStoryboard = /** @class */ (function (_super) {
    ...
    UIStoryboard.prototype.initWithName = function (name, bundle) {
        ...
        this.name = name;
        this.bundle = bundle;
        var content = mio_foundation_web_16.MIOCoreBundleGetAppResource(this.name, "json");
    ...
    UIStoryboard.prototype._instantiateViewControllerWithDestination = function (resource) {
        ...
        if (classname == null)
            return null;
        var vc = mio_foundation_web_6.NSClassFromString(classname);
...
exports.MUICoreStoryboardParseLayer = MUICoreStoryboardParseLayer;
...
exports.MUICoreStoryboardConnectOutlet = MUICoreStoryboardConnectOutlet;
...
exports.MUICoreStoryboardAddSegue = MUICoreStoryboardAddSegue;
...
var UIApplication = /** @class */ (function () {
    ...
    UIApplication.prototype.setLanguage = function (lang, target, completion) {
        var languages = mio_foundation_web_22.MIOCoreGetLanguages();
        if (languages == null) {
            completion.call(target);
        }
        ...
        var request = mio_foundation_web_17.NSURLRequest.requestWithURL(mio_foundation_web_21.NSURL.urlWithString(url));
        var con = new mio_foundation_web_19.NSURLConnection();
        con.initWithRequestBlock(request, this, function (code, data) {
            if (code == 200) {
                mio_foundation_web_25.MIOCoreStringSetLocalizedStrings(JSON.parse(data.replace(/(\r\n|\n|\r)/gm, "")));
            }
            completion.call(target);
        });
    };
    ...
    UIApplication.prototype.downloadLanguages = function (config) {
        ...
        if (langs == null) {
            ...
            for (var key in langs) {
                var url = langs[key];
                mio_foundation_web_23.MIOCoreAddLanguage(key, url);
            }
            var lang = mio_foundation_web_24.MIOCoreGetPlatformLanguage();
    ...
    UIApplication.prototype.run = function () {
        // Get App.plist
        mio_foundation_web_18.MIOCoreBundleDownloadResource("app", "plist", this, function (data) {
            if (data == null)
                throw new Error("We couldn't download the app.plist");
            var config = mio_foundation_web_20.NSPropertyListSerialization.propertyListWithData(data, 0, 0, null);
            var mainStoryBoardFile = "layout/" + config["UIMainStoryboardFile"];
            // Get Main story board
            if (mainStoryBoardFile != null) {
                mio_foundation_web_18.MIOCoreBundleDownloadResource(mainStoryBoardFile, "json", this, function (data) {
    ...
    UIApplication.prototype.downloadLanguage = function (key, fn) {
        ...
        // Download
        var conn = new mio_foundation_web_19.NSURLConnection();
        conn.initWithRequestBlock(mio_foundation_web_17.NSURLRequest.requestWithURL(url), this, function (error, data) {
            if (data != null) {
                var json = JSON.parse(data.replace(/(\r\n|\n|\r)/gm, ""));
                mio_foundation_web_25.MIOCoreStringSetLocalizedStrings(json);
            }
            fn.call(this);
        });
    };
