...
export declare function MUICoreBundleSetClassesByDestination(classes: any): void;
export declare function MUICoreBundleGetClassesByDestination(resource: string): any;
 ...
 */
export declare enum UIControlEvents {
    TouchDown = 1,
    TouchDownRepeat = 2,
    TouchDragInside = 4,
    TouchDragOutside = 8,
...
export declare class UIControl extends UIView {
    ...
    _checkSegues(): void;
    private actions;
    addTarget(target: any, action: any, controlEvents: UIControlEvents): void;
    private _enabled;
    enabled: boolean;
...
export declare class UIViewController extends NSObject {
    ...
    addChildViewController(vc: UIViewController): void;
    removeChildViewController(vc: UIViewController): void;
    ...
    prepareForSegue(segue: UIStoryboardSegue, sender: any): void;
    performSegueWithIdentifier(identifier: string, sender: any): void;
}
/**
...
export declare class UITableView extends UIView {
    ...
    initWithLayer(layer: any, owner: any, options?: any): void;
    private headerLayer;
    private addHeaderWithLayer;
    private cellPrototypes;
    private addCellPrototypeWithLayer;
    private footerLayer;
    private addFooterWithLayer;
    ...
    private addCell;
    private removeCell;
    private nextIndexPath;
    private addSectionFooter;
    reloadData(): void;
    insertRowsAtIndexPaths(indexPaths: any, rowAnimation: any): void;
    deleteRowsAtIndexPaths(indexPaths: any, rowAnimation: any): void;
    cellAtIndexPath(indexPath: NSIndexPath): any;
    indexPathForCell(cell: UITableViewCell): NSIndexPath;
    private cellDidTap;
    private cellOnClickFn;
    private cellOnEditingAccessoryClickFn;
}
...
export declare class UIStoryboard extends NSObject {
    private name;
    private bundle;
    private items;
    initWithName(name: string, bundle: NSBundle): void;
...
export declare function MUICoreStoryboardParseLayer(layer: any, object: any, owner: any): void;
export declare function MUICoreStoryboardConnectOutlet(owner: any, property: any, outletID: any): void;
export declare function MUICoreStoryboardAddSegue(owner: any, destination: string, kind: string, relationship: string, identifier: string): void;
export declare class UIStoryboardSegue extends NSObject {
    identifier: string;
    source: UIViewController;
    destination: UIViewController;
    initWithIdentifier(identifier: string, source: UIViewController, destination: UIViewController): void;
    private performHandler;
    initWithIdentifierAndPerformHandler(identifier: string, source: UIViewController, destination: UIViewController, performHandler: any): void;
    _sender: any;
    perform(): void;
}
