import { NSObject, NSSortDescriptor, _NSSortDescriptorSortObjects } from "foundation"
import { MWSRequest } from "./MWSRequest";

export class MWSCache extends NSObject
{
        ...
        this.open((status:boolean) => {
            ...
            objectStore.openCursor().addEventListener('success', (e) => {
                ...
                if(cursor){
                    ...
                    // No more entries
                    completion( _NSSortDescriptorSortObjects(items, [NSSortDescriptor.sortDescriptorWithKey("index", true)]));
                }
            });                    
        });
    }
